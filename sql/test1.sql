...
--
-- Host: localhost
-- Generation Time: Mar 15, 2023 at 05:22 AM
...
(1, 'What is Guidance System for Future University  ?', 'Guidance System for Future University s are commonly used over the internet to guide students to find the best fit with their personal preferences. It is a computer program built with the help of experts where the details of the students and their aptitudes help finding the right course for his future. This project proposes feasible predictions for student&#039;s field selection based on their marks and choice of interest. And essential to build a recommender system that provides direction and guidance to students in choosing their career. '),
...
(5, 'Vision', 'To address the aforementioned, the Guidance System for Future University  provide Senior High School students overcome their deficiencies at the same time accounting for changes overtime. They view a study program as a path to obtain graduating attributes skills, qualities, understanding and rank the impact that each course has on promoting those graduating attributes for a student who took the course.'),
(6, 'Mission', 'To successfully match students with specialty suited to both their talent, personality and academic goals. Degree compass combines data on a students past grades with transcript information from thousands of other students.'),
(7, 'Goals', 'To help students manage their own study progress in a more effective way. With this system, students would achieve better performance, find it easy to select specialties without wondering which will give them high score or which are the better for their future job or career path.'),
...
CREATE TABLE `careers` (
  ...
  `c_reqgrade` int(100) NOT NULL,
  `c_fuop` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(20, 'Psychology', 'What is the study of psychology?\r\nPsychology is the scientific study of the mind and behavior. Psychologists are actively involved in studying and understanding mental processes, brain functions, and behavior.', 'https://psychology.osu.edu/about/what-psychology', './career_img/psychology.jpg', 'i', 6, 0, ''),
(21, 'Fashion Merchandising', 'It could be a great career path for individuals who want to combine their interpersonal and negotiating skills with their love of fashion. Most buyer positions require applicants to hold a bachelor\'s degree in fashion merchandising or a related field, such as business or finance.', 'https://bestaccreditedcolleges.org/articles/careers-and-education/is-a-career-in-fashion-merchandising-a-good-choice.html', './career_img/fashion merch.jpg', 'e', 1, 0, ''),
(22, 'Real Estate', 'One successful business in the construction world is the real estate industry. This industry covers many aspects of the property such as development, leasing, appraisal, marketing, and management of commercial, residential, agricultural, and industrial properties.', 'https://www.construction21.org/articles/h/all-about-the-real-estate-industry.html?__cf_chl_jschl_tk__=pmd_GOWjS6wMges8uTKE4l.rQU9SYma49AQL_2hlBbQ3BMI-1635574362-0-gqNtZGzNApCjcnBszQi9', './career_img/real estate.png', 'e', 2, 0, ''),
(23, 'Marketing/Sales', 'Marketing includes advertising, selling, and delivering products to consumers or other businesses. Some marketing is done by affiliates on behalf of a company. Professionals who work in a corporation\'s marketing and promotion departments seek to get the attention of key potential audiences through advertising.', 'https://www.investopedia.com/terms/m/marketing.asp', './career_img/marketing sales.webp', 'e', 3, 0, ''),
...
(15, 'The result of the test feels realistic and true', 75, 'Replied', '2022-07-12 16:23:19'),
(16, 'very good to be honest.', 103, 'New', '2023-02-12 22:44:06'),
(17, 'this is very good , that was nice', 107, 'Edited', '2023-03-01 16:30:14');
...
INSERT INTO `replies` (`r_id`, `r_content`, `r_f_id`, `r_u_id`, `r_date`) VALUES
(12, 'thank you for your feedback', 15, 75, '2023-03-12 06:46:58');
...
INSERT INTO `scores` (`s_id`, `s_realistic`, `s_investigative`, `s_artistic`, `s_social`, `s_enterprising`, `s_conventional`, `s_user_id`, `s_date`) VALUES
(47, 7, 6, 6, 7, 6, 7, 103, '2023-02-08 00:19:05'),
(48, 1, 3, 2, 3, 4, 6, 107, '2023-02-21 05:44:58'),
(49, 2, 2, 2, 2, 5, 7, 108, '2023-02-21 05:48:51'),
(50, 5, 5, 3, 4, 4, 4, 109, '2023-02-21 05:56:24');

-- --------------------------------------------------------

--
-- Table structure for table `spec1`
--
...
--
-- Dumping data for table `spec1`
--

INSERT INTO `spec1` (`s_id`, `s_name`, `s_desc`, `s_image`) VALUES
(1, 'Biomedical Engineering', 'The Biomedical Engineering Major is the application of engineering principles and techniques to the medical field. Selecting the right set of Biomedical Engineering schools is important. This field seeks to close the gap between engineering and medicine. It combines the design and problem solving skills of engineering with medical and biological sciences to improve healthcare diagnosis and treatment. The Biomedical Engineering Degree has only recently emerged as its own discipline, compared to many other engineering fields.', './career_img/bio.png'),
(2, 'Information technology', 'Information technology (IT) is the use of computer systems or devices to access information. Information technology is responsible for such a large portion of our workforce, business operations and personal access to information that it comprises much of our daily activities. Whether you are storing, retrieving, accessing or manipulating information, IT greatly impacts our everyday lives.\r\n\r\nInformation technology is used by everyone from enterprise companies all the way down to one-person businesses and local operations. Global companies use it to manage data and innovate their processes. Even flea market sellers use smartphone credit card readers to collect payments and street performers give out a Venmo name to gather donations. If you use a spreadsheet to catalogue which Christmas presents you bought, you’re using information technology.', './career_img/it.png'),
(3, 'Computer-Science', 'The Computer Science major is behind almost everything electronic that happens in today’s world. A computer Science Degree is highly sought after by “Fortune 500” companies and many others, worldwide. From the internet, to the airline ticket you bought, to graphics software applications, to the medical miracles performed every day. Computer scientists are the people who create the thought processes behind every application used by a computer. Top computer science schools demand the highest amount of focus, students must have the analytical thought process that accounts for every move a piece of software must make. ', './career_img/sci.webp');
...
CREATE TABLE `users` (
  ...
  `u_spec` varchar(60) NOT NULL,
  `u_lname` varchar(60) NOT NULL,
  `u_grade` int(60) NOT NULL,
...
INSERT INTO `users` (`u_id`, `u_fname`, `u_spec`, `u_lname`, `u_grade`, `u_email`, `u_mobile`, `u_address`, `u_gender`, `u_status`, `u_religion`, `u_year`, `u_school`, `u_username`, `u_password`, `u_role`, `u_test_attempt`) VALUES
(75, 'Mohammed', '', 'Gamalaldin', 0, 'admin@gmail.com', '0118889212', 'Taif', 'Male', 'single', 'Islam', '', 'Riyadh', 'admin', 'admin123', 'admin', 0),
(103, 'Mohammed', '', 'Sanhouri', 81, 'mohammedalsanhouri@gmail.com', '0118889212', '---', 'Male', 'Single', '---', '', ' ', 'Mohammed Sanhouri', '123', 'user', 1),
(104, 'ce', '', 'Sanhouri', 0, 'aa@da.cc', '---', '---', 'Male', 'Single', '---', ' ', ' ', 'mohammedalsanhouri@gmail.com', '123', 'user', 0),
(105, 'ce', '', 'Sanhouri', 0, 'a2@da.cc', '---', '---', 'Male', 'Single', '---', ' ', ' ', 'sasaq', '1234', 'user', 0),
(106, 'v', 'Computer', 'x', 10, 'mohamed17@gmail.com', '---', '---', 'Male', 'Single', '---', '---', '---', 'si', '123', 'user', 0),
(107, 'omer', '', 'ahmed', 65, 'basem@gmail.com', '---', '---', 'Male', 'Single', '---', '---', '---', 'basem123', '1', 'user', 1),
(108, 'saleh', '', 'jamal', 75, 'saleh9999@gmail.com', '---', '---', 'Male', 'Single', '---', '---', '---', 'saleh', '1', 'user', 1),
(109, 'ali', 'Computer', 'omer', 76, 'ali@gmail.com', '---', '---', 'Male', 'Single', '---', '---', '---', 'ali', '1', 'user', 1),
(110, 'tah', 'biolgy', 'omer', 61, 'tah9@gmail.com', '---', '---', 'Male', 'Single', '---', '---', '---', 'tah12', '123', 'user', 0);
...
--
ALTER TABLE `scores`
  MODIFY `s_id` int(60) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `spec1`
--
ALTER TABLE `spec1`
...
--
ALTER TABLE `users`
  MODIFY `u_id` int(60) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
COMMIT;
