 ...
 <div class="wrapper">
  ...
  <nav id="sidebar">
    ...
    <div class="sidebar-header">
      <h6>Guidance System for Future University </h6>
    </div>
    ...
    <ul class="list-unstyled components">
      ...
      <li class="<?php if(isset($_GET['page']) && $_GET['page']=="spec"){echo "active";}?>">
        <a href="controller.php?page=spec"> <i class="bi bi-stack bi-2x"></i> Specialties</a>
      </li>
    ...
    <li class="<?php if(isset($_GET['page']) && $_GET['page']=="bot"){echo "active";}?>">
      <a href="controller.php?page=bot"> <i class="bi bi-chat-dots bi-2x"></i> chat assistante</a>
    </li>
    <li class="">
  ...
  <ul class="list-unstyled CTAs">
    <center>
      <div class="footer-text">All Rights Reserved.<br>Copyright &copy; 2024</div>
    </center>
  </ul>
</nav>
