...
<div class="container">
  ...
  if($_SESSION['u_test_attempt'] == 1){
    ...
    foreach($scores as $category => $rank) {
      $sql = "SELECT * FROM spec1 WHERE s_category = '".$category."' AND s_rank = '".$rank."'";
  ...
  function getUserFullname($u_id){
    ...
    if ($result->num_rows > 0) {
      while($row = $result->fetch_assoc()) {
        $username = $row['u_fname'].' '.$row['u_lname'];
      } 
    } 
    return $username;
  }
...
<div class="col-12 rounded bg-light border">
  ...
  <div class="box-content row">
    ...
    <div class="result-item" style="width: <?php echoPercentage(3);?>;">
      <span>Investigative&nbsp;=&nbsp;<?php echoPercentage(3);?></span>
    </div>
  ...
  <div class="col">
    <div class="result-item" style="width: <?php echoPercentage(2);?>;">
      <span>Social&nbsp;=&nbsp;<?php echoPercentage(2);?></span>
    </div>
...
<div class="col-12 rounded bg-light border">
  <div class="header"><b><?php echo getUserFullname($_SESSION['u_id'])?></b> You are Most Likely to take up...
        ...
        <div class="col-lg-12 mb-4 gallery-item">
            ...
            <div class="p-4">
              <h5> <a href="#" class="text-dark text-truncate">
                ...
                <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
                  ...
                  <button
                  type="button"
                  class="btn btn-primary active px-3" 
                  data-toggle="modal" 
          ...
          <div class="col-lg-12 mb-4 gallery-item">
            <div class="bg-white rounded shadow-sm">
              <div class="p-4">
               Related specialty to  <?php echo $row["s_name"];?>
               <?php 
               
               $related = getRelatedCourses($row["s_name"]);
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <a href="controller.php?page=<?=$row['s_name']?>" class="btn btn-outline-info">More</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer">
      ...
      if ($result->num_rows == 1) {?>
        <?php while($row = $result->fetch_assoc()) {?>
          <a href="test.pdf" target="_blank" class="btn btn-secondary active float-right">Print My Result</a> 
    ...
    <form action="processors/add_feedback.php?add-feedback=true" method="POST">
     <div class="form-group">
       <a href="test.pdf" class="btn btn-secondary active float-right">Print My Result</a> 
...
<?php
  ...
  <center>
    ...
    <a href="controller.php?page=take-test" class="btn btn-outline-primary">Take the Test</a>
  </center> 
<?php }?>
</div>
...
$pdf->SetFont('Arial','',15);
$pdf->Cell(60, 10, 'Recommended specialty: ');
$pdf->SetFont('Arial','B',15);
