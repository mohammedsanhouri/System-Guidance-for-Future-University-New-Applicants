      ...
      <div class="col-lg-12 p-2">
       ...
       <div class="row p-2">
        <div class="col-sm-3 d-flex">
          <button class="btn btn-outline-info mr-1" data-toggle="modal" data-target="#login">Edit</button>
          <a href="processors/edit-information.php?type=reset" class="btn btn-outline-danger text-red">Reset Password</a>
        </div>  
      </div>
    </div>
  </div>
...
<div class="col-lg-6">
  <div class="row">
    <div class="col-lg-12 p-2">
      ...
      <div class="row p-2">
        <div class="col-sm-3">
          <button class="btn btn-outline-info" data-toggle="modal" data-target="#personal">Edit</button>
        </div>  
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-12 p-2">
    ...
    <div class="row p-2">
      <div class="col-sm-3">
        <button class="btn btn-outline-primary" data-toggle="modal" data-target="#addinformation">Add Information</button>
      </div>  
    </div>
  </div>
</div>
